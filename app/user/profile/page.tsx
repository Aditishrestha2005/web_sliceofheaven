...
export default function ProfilePage() {
  ...
  const logout = () => {
    ...
    router.push("/register"); // ✅ as you asked
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white flex flex-col">
      ...
      {/* ✅ THIS IS THE IMPORTANT PART:
          main is exactly full height under navbar */}
      <main className="flex-1">
        <div className="h-[calc(100vh-72px)] w-full px-6 py-6">
          {/* 72px is approx navbar height; if your navbar height differs,
              change it to 80px or 64px accordingly */}

          <div className="h-full w-full grid grid-cols-1 gap-6 lg:grid-cols-12 items-stretch">
            {/* LEFT SIDEBAR (fills height) */}
            ...
            {/* RIGHT CONTENT (fills height AND touches bottom) */}
